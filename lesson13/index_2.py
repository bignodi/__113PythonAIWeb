...
#st.button("Reset",on_click=btn_clear)
...
with st.form('bmi form'):
    ...
    ## 因height/weight是由 slider/number_input 建立, 無法用session_state 清除, 需用callback function 修改
    ## 否則會報錯cannot be modified after the widget with key is instantiated.
    st.form_submit_button("清除內容", on_click=btn_clear)

    # if st.form_submit_button("清除內容"):
